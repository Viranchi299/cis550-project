  ...
  return (
    <div className="BestGenres">
      ...
      {showChoices ? (
        ...
        <AnalyzeView dataset={analyzeDataSet} showChoices={setShowChoices} />
      )}
    </div>
  );
};
const Choices = (props) => {
  ...
  return (
    <div className="center">
      <WhiteTextTypography variant="h4" component="h4" color="secondary">
      ...
      <div className={classes.root}>
        <Button
          className="choice"
          variant="contained"
          onClick={() => props.handleChoice("Home")}
        >
          Homes
        </Button>
        <Button
          ...
          variant="contained"
          color="primary"
          onClick={() => props.handleChoice("Rent")}
        >
          Rental Properties
        </Button>
        <Button
          ...
          variant="contained"
          color="secondary"
          onClick={() => props.handleChoice("Salary")}
        >
          Salaries
        </Button>
      </div>
